"""
Lambda function to calculate growth percentiles using WHO/CDC growth charts.
Supports weight, height, and head circumference calculations.
"""
...
def lambda_handler(event, context):
    """
    Lambda handler to compute growth percentiles from WHO/CDC tables.
